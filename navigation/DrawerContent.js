                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View style={{flexDirection:'row',marginTop: 15}}>
                            <Avatar.Image 
                                source={{uri: patients[1].image}}
                                size={50}
                            />
                            <View style={{marginLeft:15, flexDirection:'column'}}>
                                <Title style={styles.title}>Akash Verma</Title>
                                <Caption style={styles.caption}>@akashverma</Caption>
                            </View>
                        </View>
                    </View>
                    ...
                    <Drawer.Section style={styles.drawerSection}>
                        ...
                        <DrawerItem 
                            ...
                            label="Therapy"
                            onPress={() => {props.navigation.navigate('Therapy')}}
                        />
                        <DrawerItem 
